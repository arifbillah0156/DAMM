...
export default function DashboardPage() {
    ...
    return (
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-2 bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50'>
            <div>
                <TeacherPostForm />
            </div>
            {/*  */}
            <div>
                {showForm ? (<div className="p-4 md:p-10">
                    <div className="max-w-3xl mx-auto bg-white shadow-xl rounded-2xl p-6 md:p-10 lg:mt-6">
                        <h2 className="text-2xl md:text-3xl font-semibold text-center mb-8 text-indigo-700">প্রাতিষ্ঠানিক নোটিশ যোগ করুন</h2>
