    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 py-6 px-4 lg:px-8 relative overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto relative z-0">
                ...
                {/* Scroll to top button - adjusted position for mobile pagination */}
                {showScrollTop && (
                    <button
                        onClick={scrollToTop}
                        className="fixed bottom-24 sm:bottom-20 right-6 p-4 bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-full shadow-xl hover:from-indigo-700 hover:to-purple-700 transition-all z-20 hover:transform hover:-translate-y-1"
