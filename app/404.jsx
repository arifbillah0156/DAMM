...
export default function Custom404() {
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-100 to-blue-100 flex items-center justify-center px-6 py-12">
            <div className="max-w-3xl mx-auto text-center bg-white shadow-xl rounded-2xl p-10 border border-blue-200">
                ...
                <div className="mt-8">
                    <Link href="/">
                        <a className="inline-block px-6 py-3 bg-blue-600 text-white font-medium rounded-md shadow hover:bg-blue-700 transition">
                            🔙 হোমপেজে ফিরে যান
                        </a>
                    </Link>
                </div>
